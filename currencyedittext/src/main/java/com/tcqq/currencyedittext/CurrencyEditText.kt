...
class CurrencyEditText(context: Context, attrs: AttributeSet?) : TextInputEditText(context, attrs) {
    ...
    init {
        ...
        context.theme.obtainStyledAttributes(
            ...
            try {
                prefix = getString(R.styleable.CurrencyEditText_currency_symbol).orEmpty()
                localeTag = getString(R.styleable.CurrencyEditText_currency_locale_tag)
                useCurrencySymbolAsHint = getBoolean(R.styleable.CurrencyEditText_currency_symbol_hint, false)
            } finally {
                recycle()
            }
        }
